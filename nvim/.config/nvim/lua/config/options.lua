...
opt.formatoptions = "jcroqlnt" -- Auto-wrap text/comments, smart list alignment, clean joins
opt.jumpoptions = "view" -- Restore original scroll position when jumping back/forward
